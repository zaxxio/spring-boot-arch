package org.wsd.infrastructure.kafka;
...
import org.wsd.infrastructure.support.YamlPropertySourceFactory;


@Log4j2
@EnableKafka
@Configuration
@PropertySource(value = "classpath:kafka.yaml", factory = YamlPropertySourceFactory.class)
